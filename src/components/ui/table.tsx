...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      'in--border-b in--transition-colors hover:in--bg-muted/50 data-[state=selected]:in--bg-muted',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'in--h-12 in--px-4 in--text-left in--align-middle in--font-medium in--text-muted-foreground [&:has([role=checkbox])]:in--pr-0',
      className
    )}
    {...props}
  />
